...
//if($_REQUEST[UID]==$_SESSION[UID])header("location:$config[baseurl]/my_audio.php");



if($_REQUEST['UID']==""){
	$err="Invalid profile direction.";
}
if($err=="")
{
...
if($page=="")
$page = 1;
$sql = "SELECT count(*) as total from audio WHERE UID=$_REQUEST[UID] and type='$_REQUEST[type]' limit $config[total_per_ini]";
...
$page_link="";
for($k=1;$k<=$tpage;$k++) $page_link.="<a href='uaudios.php?UID=$_REQUEST[UID]&page=$k&type=$_REQUEST[type]'>$k</a>&nbsp;&nbsp;";
//END PAGING
}
