...
$sql="select * from video WHERE UID=$_SESSION[UID] limit $startfrom, $config[items_per_page]";
$rs=$conn->execute($sql);
...
$page_link="";
for($k=1;$k<=$tpage;$k++) $page_link.="<a href='add_video.php?urlkey={$urlkey}&gid={$gid}&page=$k&type=$_REQUEST[type]'>$k</a>&nbsp;&nbsp;";
//END PAGING
