...
if($category=="mr")$sql = "SELECT count(*) as total from video where type='public' order by addtime desc limit $config[total_per_ini]";
elseif($category=="mv")$sql = "SELECT count(*) as total from video where type='public' order by viewnumber desc limit $config[total_per_ini]";
elseif($category=="md")$sql = "SELECT count(*) as total from video where type='public' order by com_num desc limit $config[total_per_ini]";
elseif($category=="tf")$sql = "SELECT count(*) as total from video where type='public' order by fav_num desc limit $config[total_per_ini]";
elseif($category=="tr")$sql = "SELECT count(*) as total from video where type='public' order by ratedby*rate desc limit $config[total_per_ini]";
elseif($category=="rf")$sql = "SELECT count(*) as total from video where type='public' and featured='yes' order by addtime desc limit $config[total_per_ini]";
elseif($category=="rd")$sql = "SELECT count(*) as total from video where type='public' order by rand() limit $config[total_per_ini]";
...
if($category=="mr")$sql="SELECT * from video where type='public' order by addtime desc limit $startfrom, $config[items_per_page]";
